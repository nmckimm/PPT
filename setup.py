...
#
#     from ['my_module', 'sysinfo'] import metadata
#
# However, when we do this, we also import `['my_module', 'sysinfo']/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'systeminfo_cli = systeminfo.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     '['my_module', 'sysinfo']_gui = ['my_module', 'sysinfo'].gui:entry_point'
        # ]
    }
)
